...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
 ...
 <?php
        ...
        while($sql=mysqli_fetch_assoc($run)){
            ?>
<h2 class="text-center"><font color="white">UPDATE USER DETAILS</font></h2>
<div class="container">
<div class="panel panel-default panel-success">
  <div class="panel-heading">
        <form class="form" action="profile.php" method="post">
            ...
            <input type="text" class="form-control" id="phone" name="phone" pattern="^\d{4}\d{3}\d{3}$" value="<?php echo $sql['phone'] ?>">
            </div>
