...
<body>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="index.php">VIEW SALLON ID"S</a>
        </div>
...
<div style="width:100px; height:100px;"></div>
    ...
    <div class="row">
        <div class="col-sm-8">
            <h4><font color="white">SALLON ID"S</font></h4>
    ...
    <tbody>
        <?php
        include '../db/db.php';
          $query="SELECT * FROM logins WHERE who='sallon'";
          $run_query=mysqli_query($conn,$query);
          while($sql=mysqli_fetch_assoc($run_query)){
      echo '<tr>
        <td>'.$sql['name'].'</td>
        <td>'.$sql['usename'].'</td>
        <td>'.$sql['password'].'</td><td><a href="viewsallon.php?del='.$sql['id'].'" class="btn btn-danger btn-xs">DELETE</a></td>';
